window.onload = function()
{
    ...
    */
    var validaRespuesta = function(id)
    {
        ...
        var contador=0, fila=0, col=0;
        var arrayH=[], arrayV=[], arrayR=[];
    ...
    var crearEscenario = (function crearEscenario(dimension)
    {
        if(dimension % 2 !== 0)
        {
            ...
            {
                mathSquare.push([]);           //.push sirve para agregar un nuevo elemento en la matriz
